package org.muchen.aigen.utils;
...
public class WebScreenshotUtils {
    ...
    private static WebDriver initChromeDriver(int width, int height) {
        try {
            // 1. 【核心修改】配置 Chrome 驱动的国内镜像源 (解决下载报错的核心)
            System.setProperty("wdm.chromedriverUrl", "https://registry.npmmirror.com/-/binary/chromedriver/");
            // 自动管理 ChromeDriver
