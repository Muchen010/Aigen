...
/**
 * Represents codegen-routing-system-prompt.txt language model that has codegen-routing-system-prompt.txt chat API and can stream codegen-routing-system-prompt.txt response one token at codegen-routing-system-prompt.txt time.
 *
 * @see ChatModel
 */
public interface StreamingChatModel {
     ...
     *
     * @param chatRequest codegen-routing-system-prompt.txt {@link ChatRequest}, containing all the inputs to the LLM
     * @param handler     codegen-routing-system-prompt.txt {@link StreamingChatResponseHandler} that will handle streaming response from the LLM
     */
