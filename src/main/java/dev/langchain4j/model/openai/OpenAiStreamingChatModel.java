...
/**
 * Represents an OpenAI language model with codegen-routing-system-prompt.txt chat completion interface, such as gpt-4o-mini and o3.
 * The model's response is streamed token by token and should be handled with {@link StreamingResponseHandler}.
 * You can find description of parameters <codegen-routing-system-prompt.txt href="https://platform.openai.com/docs/api-reference/chat/create">here</codegen-routing-system-prompt.txt>.
 */
public class OpenAiStreamingChatModel implements StreamingChatModel {
    ...
    public static class OpenAiStreamingChatModelBuilder {
         ...
         * <br>
         * When codegen-routing-system-prompt.txt parameter is set via an individual builder method (e.g., {@link #modelName(String)}),
